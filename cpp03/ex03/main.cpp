...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/12 17:32:12 by adegl-in          #+#    #+#             */
...
int main(void)
{
	...
	std::cout << std::endl << "=== DiamondTrap creation ===" << std::endl;
	DiamondTrap diamond1("Grok");
	DiamondTrap diamond2("Llama");

	std::cout << std::endl << "=== whoAmI ===" << std::endl;
	diamond1.whoAmI();
	diamond2.whoAmI();

	std::cout << std::endl << "=== Attack (uses ScavTrap's attack) ===" << std::endl;
	diamond1.attack("Llama");
